...
// *                                                                          *
// * Copyright 2008-2012 NameCheap.com                                        *
// *                                                                          *
...
// * - Replaced classes NamecheapApi and NamecheapApiException with NamecheapRegistrarApi and NamecheapRegistrarApiException
...
function namecheap_GetContactDetails($params)
{
    ...
    try
    {
        ...
        if (!empty($attr)) {
            if (in_array(strtolower($tld), array("us", "ca", "co.uk", "org.uk", "me.uk"))) {
                if (!defined('CLIENTAREA') || CLIENTAREA != true) {
                    $msg = strtoupper($tld)
            ...
            $key = strtoupper(str_replace('.', '', $tld));
            if (("co.uk" == strtolower($tld) || "org.uk" == strtolower($tld) || "me.uk" == strtolower($tld)) && !isset($attr[$key . 'CompanyID'])) {
